...
if [[ "$sys_info" = "Linux" &&  ("$arch_info" = "x86_64"  ||  "$arch_info" = "amd64") ]]; then
  curl -Lo ./_linux-64.tar.gz "https://github.com/MHSanaei/3x-ui/releases/download/$version/x-ui-linux-amd64.tar.gz"
  ...
  curl -Lo ./_linux-64.tar.gz "https://github.com/MHSanaei/3x-ui/releases/download/$version/x-ui-linux-arm64.tar.gz"
...
echo "if you have no write permission in /etc or /var, please execute [export XUI_DB_FOLDER=./ && export XUI_LOG_FOLDER=./]"
echo "CMD: ./ray_ui_assets/ray-ui"
